...
### 2026-01-30
- 添加后端服务对接章节
- 引用后端项目文档路径（AGENTS.md、API 文档、测试指南）
- 添加后端模块结构说明
- 添加 API 快速参考和核心接口清单
...
graph TD
    ...
    click Components "src/components/ui/AGENTS.md" "查看组件库"
    click Stores "src/stores/AGENTS.md" "查看状态管理"
    click Composables "src/composables/AGENTS.md" "查看可组合函数文档"
    click API "src/api/AGENTS.md" "查看 API 文档"
...
**文档：** [src/views/AGENTS.md](src/views/AGENTS.md)
...
**文档：** [src/stores/AGENTS.md](src/stores/AGENTS.md) | [src/composables/AGENTS.md](src/composables/AGENTS.md)
...
**文档：** [src/components/ui/AGENTS.md](src/components/ui/AGENTS.md)
...
**详细文档：** [src/api/AGENTS.md](src/api/AGENTS.md)
...
| 文档 | 路径 | 说明 |
|------|------|------|
| **后端 AI 上下文** | `D:\JavaCodeStudy\wangyiyun-music\AGENTS.md` | 后端项目完整架构、模块索引、开发规范 |
| **后端索引 JSON** | `D:\JavaCodeStudy\wangyiyun-music\.Codex\index.json` | 后端项目元数据、模块结构、覆盖率报告 |
...
**文档：** [src/stores/AGENTS.md](src/stores/AGENTS.md)
...
详细模块文档请查看各模块目录下的 `AGENTS.md`：

| 模块 | 文档路径 |
|------|----------|
| API 层 | [src/api/AGENTS.md](src/api/AGENTS.md) |
| UI 组件库 | [src/components/ui/AGENTS.md](src/components/ui/AGENTS.md) |
| 状态管理 | [src/stores/AGENTS.md](src/stores/AGENTS.md) |
| 可组合函数 | [src/composables/AGENTS.md](src/composables/AGENTS.md) |
| 页面视图 | [src/views/AGENTS.md](src/views/AGENTS.md) |
| 工具函数 | src/utils/AGENTS.md（待补充）|
| 路由配置 | src/router/AGENTS.md（待补充）|
...
- **缺少文档**：src/utils/AGENTS.md, src/router/AGENTS.md, src/components/player/AGENTS.md
